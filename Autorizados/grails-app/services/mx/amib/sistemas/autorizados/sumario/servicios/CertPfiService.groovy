...
class CertPfiService {
	def dataSource

	static transactional = true

	def guardaExcel(mapaCeldas) {
		Boolean guardaCertPfi=true
		...
		guardaCertPfi=listaColumnas.size()==10
		log.debug("Se guardara ceerte experiencia? ${guardaCertPfi}")
		...
		placeHoldersStr+="?"
		if(guardaCertPfi){
			nombreTablon="t017_d_certificacionpfi"
